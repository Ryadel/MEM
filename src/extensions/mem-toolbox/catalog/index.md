...
The initial catalogue is deliberately scoped to image processing: small and opinionated, a default toolchain
rather than an encyclopedia. Its value is preference and provenance — which tool to reach for, and where it comes
from — not explaining what well-known tools are.
...
| Upscale an image | [realesrgan-ncnn-vulkan](realesrgan-ncnn-vulkan.md) |
...
terms change, and a stale licence claim is worse than none.
